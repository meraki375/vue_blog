...
const menuList: LeftMenuItem[] = reactive([ 
  { id: '01', name: '用户管理', value: UserManage, icon: 'icon-user-group' },
  { id: '02', name: '角色管理', value: RoleManage, icon: 'icon-robot' },
  { id: '03', name: '菜单管理', value: MenuManage, icon: 'icon-menu' },
  { id: '04', name: '个人中心', value: UserCenter, icon: 'icon-user' }
])
