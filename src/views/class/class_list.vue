<template>
    <div class="table-page">
        ...
        >
            ...
            <a-input-group>
                <a-input placeholder="请输入分类名称..." allow-clear style="width: 250px" v-model="data.q"> </a-input>
            ...
            <a-table-column title="分类名称" data-index="name" :width="120" align="center"></a-table-column>
        ...
        <a-modal v-model:visible="visible" @ok="handleOk" @cancel="handleCancel">
            <template #title>
            {{ data.classForm.id ? '编辑分类' : '新增分类' }}
            </template>
            <div>
                <a-form :model="data.classForm" ref="formRef">
                    <a-form-item field="name" label="分类名称">
                        <a-input placeholder="请输入分类名称..." allow-clear style="width: 250px" v-model="data.classForm.name"> </a-input>
                    </a-form-item>
